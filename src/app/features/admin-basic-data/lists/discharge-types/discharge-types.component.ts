...
@Component({
  selector: 'app-discharge-types',
  templateUrl: './discharge-types.component.html',
  styleUrls: ['./discharge-types.component.scss']
})
export class DischargeTypesComponent implements OnInit {
