...
export class ManageRolesClerkService {
    ...
    getRoles(): Observable<any> {
      return this.http.get<RolesClerk>(`${this.getUrl()}/roles`);
    }
    /**
    ...
    /**
     * Create new role in clerk realm
     * @returns { Observable } - data response of request
     */
    ...
    /**
     * Edit a role by id in clerk realm
     * @returns { Observable } - data response of request
     */
    editRole(roleId : string, roleInfo : EditRoleClerkDTO): Observable<any> {
     ...
     /**
     * Delete a role by id in clerk realm
     * @returns { Observable } - data response of request
     */
