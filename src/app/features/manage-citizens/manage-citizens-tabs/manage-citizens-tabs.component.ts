...
@Component({
  selector: 'app-manage-citizens-tabs',
  templateUrl: './manage-citizens-tabs.component.html',
  styleUrls: ['./manage-citizens-tabs.component.scss']
})
export class ManageCitizensTabsComponent implements OnInit {
